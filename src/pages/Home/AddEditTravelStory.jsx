...
const AddEditTravelStory = ({
  ...
  const [visitedLocation, setVistedLocation] = useState(storyInfo?.visitedLocation || []);
        ...
        <div>
          <div className="flex items-center gap-3 bg-cyan-50/50 p-2 rounded-l-lg">
            {type === 'add' ? <button className="btn-small" onClick={handleAddOrUpdateClick}>
              <p className='text-lg'>+</p> ADD STORY
            </button> : <>
            ...
            <button className="" onClick={onClose}>
              <p className='text-lg text-slate-400'> &nbsp;&nbsp;x&nbsp;&nbsp; </p>
            </button>
          </div>
      ...
      <div>
        <div className="flex-1 flex flex-col gap-2 pt-4">
          ...
          <div className="pt-3">
            ...
            <TagInput tags={visitedLocation} setTags={setVistedLocation} />
          </div>
