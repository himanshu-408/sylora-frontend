...
const TravelStoryCard = ({key, imgUrl, title, story, date, visitedLocation, isFavourite, onEdit, onClick, onFavouriteClick}) => {
  return (
    <div className="border rounded-lg overflow-hidden bg-white hover:shadow-lg hover:shadow-slate-200 transition-all ease-in-out relative cursor-pointer">
      ...
      <button onClick={onFavouriteClick} className="w-12 h-12 flex items-center justify-center bg-white/40 rounded-lg border border-white/30 absolute top-4 right-4"><p className="icon-btn {isFavourite ? 'text-red-500' : 'text-white'}">+</p></button>
      ...
      <div className="p-4" onClick={onClick}>
          ...
          <div className="inline-fle items-center gap-2 text-[13px] text-cyan-600 bg-cyan-200/40 rounded mt-3 px-2 py-1">
