  ...
  return (
    <div>
      ...
      {openDatePicker && <div className="overflow-y-scroll p-5 bg-sky-50/80 rounded-lg relative pt-9">
        <button className="w-10 h-10 rounded-full flex items-center bg-sky-100 hover:bg-sky-100 absolute top-2 right-2 " onClick={() => {
          setOpenDatePicker(false);
        }}><p className='text-xl text-sky-600 '>x</p></button>  
